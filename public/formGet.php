...
function ciniki_forms_formGet($ciniki) {
    ...
    //
        ...
        $rc = ciniki_core_dbHashQueryArrayTree($ciniki, $strsql, 'ciniki.forms', array(
            array('container'=>'forms', 'fname'=>'id', 
                'fields'=>array('name', 'permalink', 'type', 'status', 'flags', 
                    'max_submissions', 'max_customer_submissions', 'notify_emails',
        ...
        $form['statuses'] = array(
            ...
            '_104' => array('id'=>104, 'label'=>'Processing', 'num_submissions'=>(isset($statuses[104]) ? $statuses[104] : 0)),
            '_107' => array('id'=>107, 'label'=>'Completed', 'num_submissions'=>(isset($statuses[107]) ? $statuses[107] : 0)),
            ...
            '_70' => array('id'=>70, 'label'=>'Pending Payment', 'num_submissions'=>(isset($statuses[70]) ? $statuses[70] : 0)),
