    ...
    this.form.sections = {
        ...
        'options':{'label':'Other Options', 
            ...
            'fields':{
                ...
                'flags4':{'label':'Email Submission to Customer', 'type':'flagtoggle', 'default':'off', 'bit':0x08, 'field':'flags'},
                'flags8':{'label':'No Editing Submissions', 'type':'flagtoggle', 'default':'off', 'bit':0x80, 'field':'flags'},
                'notify_emails':{'label':'Notify Emails', 'type':'text', 'hint':'Emails to receive notifications'},
