...
// -------
//
function ciniki_forms_hooks_customerMerge($ciniki, $tnid, $args) {
    ...
    //
    // Get the list of form submissions items to update
    //
    $strsql = "SELECT id "
    ...
    if( $updated > 0 ) {
        ...
        ciniki_tenants_updateModuleChangeDate($ciniki, $tnid, 'ciniki', 'forms');
    }
